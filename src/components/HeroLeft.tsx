          ...
          return (
            ...
            >
              <div className="flex justify-between items-start mb-12">
                <div>
                  <h3
                    className={`text-2xl font-black uppercase tracking-tighter ${isToday ? 'text-neutral-100' : 'text-neutral-900 dark:text-neutral-100'}`}
                  >
                    {item.day}
                  </h3>
                  <p
                    className={`text-[10px] font-black uppercase tracking-[0.2em] mt-2 ${isToday ? 'text-neutral-500' : 'text-neutral-400 dark:text-neutral-400'}`}
                  >
                    {item.date}
                  </p>
                </div>
                <div
                  className={`p-4 rounded-2xl ${isToday ? 'bg-neutral-800' : 'bg-neutral-200 dark:bg-neutral-600'}`}
                >
              ...
              <div className="mb-14">
                ...
                <p
                  className={`text-xl font-black uppercase italic mt-6 tracking-[0.1em] border-l-4 pl-4 ${isToday ? 'text-yellow-400 border-yellow-400' : 'text-neutral-600 border-neutral-900 dark:text-neutral-300 dark:border-neutral-100'}`}
                >
                  {item.condition}
                </p>
              </div>
              ...
              <div
                className={`grid grid-cols-2 gap-8 pt-8 border-t-2 ${isToday ? 'border-neutral-800' : 'border-neutral-200 dark:border-neutral-600'}`}
              >
                <div className="flex flex-col">
                  <span
                    className={`text-[10px] font-black uppercase tracking-[0.2em] mb-2 ${isToday ? 'text-neutral-600' : 'text-neutral-400 dark:text-neutral-500'}`}
                  >
                    Humidity
                  </span>
